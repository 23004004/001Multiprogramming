...
case "$TARGET" in
  versatilepb)
    ...
    LDFLAGS="-T ../user/P1/linker.ld --defsym=MEM_ADDR=0x00100000"
...
$LD $LDFLAGS -o bin/process_1.elf bin/root.o bin/uart.o bin/stdio.o bin/stdlib.o bin/syscalls.o bin/process_1.o
